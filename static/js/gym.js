    ...
    forms.forEach((form) => {
        form.addEventListener("submit", function (e) {
            ...
            .then(() => {
                ...
                if (currentForm.id === "contactForm" || currentForm.name === "contact-general") {
                    const formContainer = document.getElementById("contactFormContainer");
                    const successDiv = document.getElementById("contactConfirmationMessage");

                    // Tranzicioni: Fsheh formën, shfaq suksesin
                ...
                else if (currentForm.id === "gymForm" || currentForm.name === "regjistrim-palestra") {
